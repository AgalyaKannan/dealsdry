...
import 'package:chatapp/app/modules/catogorytemplt/bindings/catogorytemplt_binding.dart';
import 'package:chatapp/app/modules/catogorytemplt/views/catogorytemplt_view.dart';
import 'package:chatapp/app/modules/forgetpswrd/bindings/forgetpswd_binding.dart';
import 'package:chatapp/app/modules/forgetpswrd/views/forgetpswrd_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.PLAYERTEMPLT,
      page: () => PlayertempltView(),
      binding: PlayertempltBinding(),
    ),
    GetPage(
      name: _Paths.CATOGORYTEMPLT,
      page: () => CatogorytempltView(),
      binding: CatogorytempltBinding(),
    ),
    GetPage(
